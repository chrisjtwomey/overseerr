...
const messages = defineMessages({
  keywordBooks: '{keywordTitle} Books',
});

const DiscoverBookKeyword = () => {
  ...
  const {
    ...
    error,
    firstResultData,
  } = useDiscover<BookResult, { keywords: TmdbKeyword[] }>(
  ...
  const title = isLoadingInitialData
    ...
    : intl.formatMessage(messages.keywordBooks, {
...
export default DiscoverBookKeyword;
